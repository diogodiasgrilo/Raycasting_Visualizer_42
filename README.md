...
```
You can move the square-looking player around with the ASDW keys and the square will move in the direction that the rays are pointed at, either left, right, up, or down.
